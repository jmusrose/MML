...
Loss helpers carried over from ``DML_v1/RGB_v1/tool/loss.py``.

Note: the current CMU baseline does not directly use ``metric_loss`` or
``FocalLoss``; they are kept here as skeleton utilities for future
experiments (mirroring the RGB_v1 layout).
"""
