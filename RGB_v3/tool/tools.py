...
Small utility helpers shared across the DML_v1/RGB pipeline.

Currently only contains ``weight_init`` (carried over from
``CPSC_CREMAD/utils/tools.py``).  Extra helpers can be added here as the
project evolves.
"""
