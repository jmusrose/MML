...
class DMLClassifier(nn.Module):
    ...
    def forward(self, audio, video):
        ...
        audio_latent = self._sample_features(audio_mu, audio_logvar)
        video_latent = self._sample_features(video_mu, video_logvar)
        audio_logits = self.audio_clf(audio_latent)
        video_logits = self.video_clf(video_latent)
        ...
        return fused_logits, audio_logits, video_logits, audio_latent, video_latent, ib_loss
